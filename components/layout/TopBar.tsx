    ...
    <header className="fixed top-0 left-0 right-0 z-30 bg-black/90 backdrop-blur-md border-b border-white/5">
      <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-1">
          ...
          <Link
            href="/profile"
            className={`ml-2 w-8 h-8 rounded-full border flex items-center justify-center text-xs font-mono transition-colors ${
              pathname === '/profile'
                ? 'border-gold text-gold bg-gold/10'
                : 'border-white/20 text-cream/60 hover:border-gold/40'
            }`}
          >
